...
<div id="titlebar" class="gradient">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 data-aos="fade-right" data-aos-duration="2000">Agents</h2>
        <nav id="breadcrumbs">
      ...
      foreach ($get_jobs as $get_job) {
        ...
        <div class="col-xl-12 col-md-12">
          <div class="utf-section-headline-item  margin-top-0 margin-bottom-40">
            <h3 data-aos="zoom-in-down" data-aos-duration="1000"><?php echo $get_job['heading']; ?></h3>
            <div class="utf-headline-display-inner-item"><?php echo $get_job['heading']; ?></div>
          </div>
          <p data-aos="fade-down" data-aos-duration="3000"><?php echo $get_job['dcp']; ?></p>
       </div> 
       <?php
