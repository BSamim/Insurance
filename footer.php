     ...
     <div class="utf-popup-container-part-tabs">
       ...
       <div class="utf-popup-tab-content-item" id="login">
         ...
         <form method="post" id="login-form">
           ...
           <div class="checkbox margin-top-0" style="display:flex">
             <input type="radio" id="two-step" name="checktype">
             <label style="padding-left: 27px;" name="label" for="two-step"><span class="checkbox-icon"></span><a href="user/index.php">User</a></label>
             <input type="radio" id="one-step" name="checktype">
             <label style="margin-left: 20px;padding-left: 27px;" name="label" for="one-step"><span class="checkbox-icon"></span>Vender</a></label>
           </div>
       ...
       <div class="utf-popup-tab-content-item" id="register">
         ...
         <form action="action.php" method="post" id="utf-register-account-form">
           ...
           <div class="checkbox margin-top-0" style="display:flex">
             <input type="radio" id="two_step" name="checktype">
             <label style="padding-left: 27px;" name="label" for="two_step"><span class="checkbox-icon"></span><a href="user/index.php">User</a></label>
             <input type="radio" id="one_step" name="checktype">
