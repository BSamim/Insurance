					...
					<div class="row">
						...
						if ($insurences) {
							foreach ($insurences as $insurence) {
								...
								<!-- update modal -->
								<div class="modal fade" id="myModal1<?php echo $insurence['id']; ?>" role="dialog">
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<form method="POST" action="action.php" enctype="multipart/form-data" >
													...
													<button name="update_banner" type="submit" class="btn btn-success text-center ml-3 mt-3">Submit</button>
												</form>
											</div>
										</div>
									</div>
