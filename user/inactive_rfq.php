              ...
              ?>
                  <li>
                    ...
                    <div class="utf-buttons-to-right">
                      <a href="#small-dialog" class="popup-with-zoom-anim button green ripple-effect ico" title="Activate" data-tippy-placement="top"><i class="icon-feather-check-circle"></i></a>
