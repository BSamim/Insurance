         ...
         <div class="utf-dashboard-nav">
           <div class="utf-dashboard-nav-inner">
             ...
             <ul>
               ...
               <li><a href="get_a_quote.php"><i class="icon-line-awesome-user-secret"></i> Get a Quote</a></li>
               <li><a href="intrested_vender.php"><i class="icon-feather-heart"></i> Intrested Vender</a></li>
